...
public final class QueryLocation {
    ...
    public static final String LOG_TAG = QueryLocation.class.getSimpleName();

    /** Sample JSON response for a USGS query */

    /**
     * Create a private constructor because no one should ever create a {@link QueryLocation} object.
    ...
    public static List<String> fetchData(String requestUrl) {
        ...
        List<String> locations = extractData(jsonResponse);
    ...
    public static List<String> extractData(String jsonResponse) {
