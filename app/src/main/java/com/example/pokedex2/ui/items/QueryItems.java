...
public final class QueryItems {

    /** Tag for the log messages */
    public static final String LOG_TAG = QueryItems.class.getSimpleName();

    /** Sample JSON response for a USGS query */

    /**
     * Create a private constructor because no one should ever create a {@link QueryItems} object.
    ...
    public static List<Item> fetchData(String requestUrl) {
        ...
        List<Item> items = extractData(jsonResponse);
    ...
    public static List<Item> extractData(String jsonResponse) {
